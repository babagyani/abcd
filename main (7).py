...
BUTTONSCONTACT = InlineKeyboardMarkup([[InlineKeyboardButton(text="📞 Contact", url="https://t.me/askmecourse_bot")]])
keyboard = InlineKeyboardMarkup(
    [
        [
            InlineKeyboardButton(text="📞 Contact", url="https://t.me/askmecourse_bot"),
            InlineKeyboardButton(text="🛠️ Help", url="https://t.me/askmecourse_bot"),
        ],
    ]
)
...
async def txt_handler(client: Client, m: Message):
    await bot.send_message(m.chat.id, text= (
        ...
        f"┏━━━━━━━━━━━━━━━━━━━━━━━┓\n"
        f"             🧠 𝐌𝐚𝐝𝐞 𝐁𝐲: [𝐉𝐀𝐀𝐓 𝐁𝐎𝐓𝐒](https://t.me/askmecourse_bot)\n"
        f"┗━━━━━━━━━━━━━━━━━━━━━━━┛"
        )
    )
...
async def txt_handler(bot: Client, m: Message):
    ...
    if raw_text3 == '1':
        CR = '[𝄟⃝‌🐬𝐉𝐀𝐀𝐓 𝐁𝐎𝐓𝐒🐬](https://t.me/askmecourse_bot)'
    else:
        CR = raw_text3

    await editable.edit("**🔹Enter Your PW Token For 𝐌𝐏𝐃 𝐔𝐑𝐋\n\nsend classplus working token for classplus download\n\n🔹Send /anything for use default**")
    ...
    if raw_text5.strip() == "/d":
        ...
        app = raw_text5.strip() or "𝐉𝐀𝐀𝐓 𝐁𝐎𝐓𝐒"
            ...
            try:
                ...
                if "drive" in url:
                    ...
                    Show = f"🚀𝐏𝐫𝐨𝐠𝐫𝐞𝐬𝐬 » {progress:.2f}%\n┃\n" \
                           ...
                           f"╰━✦𝐁𝐨𝐭 𝐌𝐚𝐝𝐞 𝐁𝐲 ✦ [𝐉𝐀𝐀𝐓 𝐁𝐎𝐓𝐒❤️](https://t.me/askmecourse_bot)"
    ...
    try:
            ...
            try:
                ...
                if "drive" in url:
                    ...
                    Show = f"**⚡Dᴏᴡɴʟᴏᴀᴅɪɴɢ Sᴛᴀʀᴛᴇᴅ...⏳**\n" \
                           f"🔗𝐋𝐢𝐧𝐤 » {url}\n" \
                           f"✦𝐁𝐨𝐭 𝐌𝐚𝐝𝐞 𝐁𝐲 ✦ [𝐉𝐀𝐀𝐓 𝐁𝐎𝐓𝐒❤️](https://t.me/+MdZ2996M2G43MWFl)"
                    prog = await m.reply_text(Show, disable_web_page_preview=True)
                    res_file = await helper.decrypt_and_merge_video(mpd, keys_string, path, name, raw_text2)
                    filename = res_file
                    await prog.delete(True)
